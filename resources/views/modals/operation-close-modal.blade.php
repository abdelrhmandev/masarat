<div class="show-close-operation-modal">
    <div class="close-operation-modal hidden fixed z-10 inset-0 overflow-y-auto text-center"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20  sm:block sm:p-0">
            ...
            <div
                ...
                <form method="POST" action="{{ route('admin.operationDoExecution') }}" enctype="multipart/form-data">
                    <input type="hidden" value="" name="form_id" id="modal-action-form-id" />
                    <input type="hidden" value="" name="to_role" id="modal-action-to-role" />
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div
                            ...
                            <h3 class="text-lg leading-6 font-medium" id="modal-title">
                                {{ trans('interventions.hang-beneficiary-modal') }}</h3>
                        </div>
                        <div class="mt-3">
                            {{ csrf_field() }}
                            <div class="col-span-6 sm:col-span-3 py-2">
                                <label for="close_notes"
                                    class=" text-sm font-medium text-gray-700">{{ trans('interventions.hang-details') }}</label>
                                <textarea id="close_notes" oninvalid="this.setCustomValidity('يجب تدوين تفاصيل سبب رفض المستفيد للتدخل')"
                                    oninput="this.setCustomValidity('')"
                                    pattern="[\u0621-\u064A\u0660-\u0669a-zA-Z ]{3,30}" name="close_notes" rows="4"
                                    cols="50"
