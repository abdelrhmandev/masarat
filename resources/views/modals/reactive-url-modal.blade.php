<div class="show-reactive-url-modal">
    <div class="reactive-modal hidden fixed z-10 inset-0 overflow-y-auto text-center">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20  sm:block sm:p-0">
            ...
            <div
                ...
                <form method="POST" action="{{ route('admin.reactiveUrl') }}" enctype="multipart/form-data">
                    <input type="hidden" value="" name="personal_id" id="personal-id-data" />
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div
                            ...
                            <h3 class="text-lg leading-6 font-medium" id="modal-title">
                                {{ trans('interventions.reactive-url') }}</h3>
                        </div>
                        <div class="mt-3">
                            {{ csrf_field() }}
                            <div class="col-span-6 sm:col-span-3 py-2">
                                <select id="reactiveDate" name="reactiveDate"
                                    class="text-xs border border-gray-300 rounded-md text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                                    <option value="0">{{ trans('interventions.select-day') }}</option>
