<div class="reason-modal">
    <div class="fixed inset-0 z-10 hidden overflow-y-auto text-center reason-modal" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="flex items-center justify-center h-12 mx-auto text-white bg-indigo-600 rounded-full grow">
                            ...
                            <h3 class="text-lg leading-6 font-medium" id="modal-title">{{ trans('interventions.rejection-reason') }}</h3>
                        </div>
                        <div class="mt-3">
                            {{ csrf_field() }}
