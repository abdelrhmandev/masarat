<div class="show-orphan-objective-add-modal">
    <div class="orphan-objective-add-modal hidden fixed z-10 inset-0 overflow-y-auto text-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
