<div class="approve-modal">
    <div class="approve-modal hidden fixed z-10 inset-0 overflow-y-auto text-center" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20  sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class=" ">
                        <div
                            ...
                            <h3 class="text-lg leading-6 font-medium" id="modal-title">
                                {{ trans('interventions.approve-support') }}</h3>
                        </div>
                        <div class="mt-3">
                            {{ csrf_field() }}
                    ...
                    <div id="inner-approve-content"></div>
                </div>
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button"
                        class="close-the-approve-modal mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">{{ trans('modals.confirm_modal_button_cancel_text') }}</button>
                </div>
            </div>
        </div>
    </div>
