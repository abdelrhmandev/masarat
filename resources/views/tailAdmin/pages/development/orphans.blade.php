                ...
                <table id="casesList" class="min-w-full divide-y divide-gray-200 text-center bg-gray-50">
                    <thead class="font-bold text-sm">
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(2)" class="py-3 text-gray-500 tracking-wider">
...
@if($current_stage_id && $new_orphans_counter>0)
