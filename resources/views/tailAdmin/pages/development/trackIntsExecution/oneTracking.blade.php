...
<h1 class="ml-8 mb-4 text-2xl font-semibold underline underline-offset-8 decoration-indigo-600 text-indigo-400">
    {{ trans('trackIntsExecution.ints.title') }}
</h1>
@endsection
    ...
    <div class="w-full mx-auto lg:max-w-4xl">
        <div class="relative">
            <div class="flex justify-center">
                <button type="submit" class="font-bold items-center justify-center px-14 py-2 border border-transparent text-base rounded-md text-white bg-[#0097a0]">
                    نوع التدخل : {{ $trackdata[0]->name_ar }}
                </button>
            </div>
            <div class="flex justify-center py-2">
                <button type="submit" class="font-bold items-center justify-center px-24 py-2 border border-transparent text-base rounded-md text-white bg-[#0097a0]">
                        ...
                        <div class="flex items-center justify-start w-full mx-auto">
                            <div class="w-full lg:w-1/2 lg:pr-8">
                                <div class="p-4 bg-white rounded shadow-lg shadow-cyan-300">
                                    ...
                                    <p class="font-bold text-center p-2">بواسطه :
                                        {{ $onetrack->username ? $onetrack->username : $pen_name[0]->pen_name }}
                                    </p>
                                    <p class="font-bold text-center p-2">في يوم :
                                        {{ \Carbon\Carbon::parse($onetrack->updated_at)->format('d/m/Y') }}
                                    </p>
