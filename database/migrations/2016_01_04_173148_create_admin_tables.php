...
class CreateAdminTables extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('admin.database.users_table'), function (Blueprint $table) {
            ...
            $table->boolean('int_housing', 1)->default(0);
            $table->boolean('int_direct', 1)->default(0);
            $table->boolean('int_health', 1)->default(0);
            $table->boolean('int_job', 1)->default(0);
            $table->boolean('active', 1)->default(1);
            $table->boolean('int_logistic', 1)->default(0);
